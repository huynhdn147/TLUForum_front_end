...
import { SharedDirectivesModule } from '@app/shared/directives/share-directive.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    ContentsRoutingModule,MessagesModule,
    PanelModule,
    ButtonModule,
    TableModule,
    PaginatorModule,
  ...
  providers: [
    ...
    BsModalService,
    DatePipe
  ],exports:[CommentsDetailComponent,CommentsComponent]
})
