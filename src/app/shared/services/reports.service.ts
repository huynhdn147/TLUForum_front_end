...
export class ReportsService extends BaseService {
    ...
    getAllPaging(knowledgeBaseId, filter, pageIndex, pageSize) {
        return this.http.get<Pagination<Report>>(`${environment.apiUrl}/api/KnowledgeBases/${knowledgeBaseId}/reports/filter?filter=${filter}&pageIndex=${pageIndex}&pageSize=${pageSize}`, { headers: this._sharedHeaders })
