...
export class RolesService extends BaseService {
    ...
    update(id: string, entity: Role) {
        return this.http.put(`${environment.apiUrl}/api/roles/id?id=${id}`, JSON.stringify(entity), { headers: this._sharedHeaders })
            .pipe(catchError(this.handleError));
    }

    getDetail(id) {
        return this.http.get<Role>(`${environment.apiUrl}/api/roles/id?id=${id}`, { headers: this._sharedHeaders })
            .pipe(catchError(this.handleError));
    }
    ...
    delete(id) {
        return this.http.delete(environment.apiUrl + '/api/roles/id?id=' + id, { headers: this._sharedHeaders })
            .pipe(
                catchError(this.handleError)
            );
    }
